...
void MDAPiano::update() noexcept
{
    ...
    float param0 = _params.envDecayParam->get() / 100.0f;
    ...
    float param1 = _params.envReleaseParam->get();
    ...
    float param2 = _params.hardnessParam->get();
    ...
    float param5 = _params.velocityToMufflingParam->get() / 100.0f;
    ...
    // from 1.5 to 3.0.
    float param6 = _params.velocitySensitivityParam->get() / 100.0f;
    ...
    float param7 = _params.stereoWidthParam->get() / 200.0f;
    ...
    _fine = _params.fineTuningParam->get() / 100.0f;
...
void MDAPiano::noteOn(int note, int velocity) noexcept
{
    if (velocity > 0) {
        // === Find voice ===
